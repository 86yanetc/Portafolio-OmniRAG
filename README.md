...
Este es un proyecto a gran escala. Para mantenerlo manejable y profesional, utilizaremos una arquitectura modular y desacoplada donde cada tipo de RAG es un **Motor** (Engine) independiente, orquestado por FastAPI y visualizado con Streamlit, utilizando exclusivamente el 
